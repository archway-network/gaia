...
var (
	pattern_Query_History_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"gaia", "chat", "v1beta1", "history"}, "", runtime.AssumeColonVerbOpt(false)))
)
